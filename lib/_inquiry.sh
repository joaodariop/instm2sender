...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador M2Sender, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar M2Sender\n"
  printf "   [1] Atualizar M2sender\n"
  printf "   [2] Deletar M2Sender\n"
  printf "   [3] Bloquear M2Sender\n"
  printf "   [4] Desbloquear M2Sender\n"
  printf "   [5] Alter. dominio M2Sender\n"
  printf "\n"
  read -p "> " option
